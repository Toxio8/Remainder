...
public class CaveGenerator extends BlockPopulator {
    ...
    private final List<BlockParameters> blocks = new ArrayList<>();

    private final Map<Material, Material> removeBlocks = new HashMap<>();

    public void registerBlocks(BlockParameters blockParameters) {
        this.blocks.add(blockParameters);
    }

    public void registerBlocks(BlockParameters blockParameters, Material replaceOthers) {
        registerBlocks(blockParameters);
        this.removeBlocks.put(blockParameters.id, replaceOthers);
    }
    ...
    public void populate(World world, Random random, Chunk chunk) {
        ...
        for (BlockParameters bloc : this.blocks) {
            try {
    ...
    private void generate(World world, Random rand, int x, int y, int z, double size, BlockParameters material) {
